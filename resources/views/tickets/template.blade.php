...
.pass h2 {
  ...
  font-size: 1.5rem;
  color: #dd349c;
  text-transform: uppercase; /* Alternativa a small-caps */
}
...
<body>
  <div class="pass">
    <div class="container">
        ...
        <p style="font-size: 18px;"><strong>Fecha:</strong> {{ \Carbon\Carbon::parse($ticket->event->event_date)->format('d-m-Y') }}</p>
